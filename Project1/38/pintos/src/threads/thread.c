...
void thread_get_recent_cpu_update( struct thread *t, void *aux UNUSED){
...
void thread_priority_update( struct thread *t, void *aux UNUSED){
		    int a, b;
...
bool priority_for_max(const struct list_elem *a, const struct list_elem *b, void *aux UNUSED)
{
	struct thread *t1;
	struct thread *t2;
...
bool wakeUpTime_less(const struct list_elem *a, const struct list_elem *b, void *aux UNUSED)
{
	struct thread *t1;
	struct thread *t2;
